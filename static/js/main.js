...
window.addEventListener('load', () => {
    let servicecontainer = select('.section-container');
    if (servicecontainer) {
      let serviceIsotope = new Isotope(servicecontainer, {
        itemSelector: '.service-item'
      });

      let servicefilters = select('#categories-filters li', true);

      on('click', '#categories-filters li', function(e) {
        e.preventDefault();
        ...
        serviceIsotope.on('arrangeComplete', function() {
          AOS.refresh()
        });
      }, true);
    }
